...
[JavaScript version](docs/scripts/re_corder.js) requires no setup and works in any
browser that supports the Web MIDI API. Just click on the
[link](https://nettoyeurny.github.io/re_configure/) and have fun!
